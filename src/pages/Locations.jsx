    ...
    const getAvData = async () => {
      if (usersData) {
        try {
          ...
          const url = `${baseURL}/api/v1/sitesAv`;
          const body = {
            usersData: usersData,
            filter:
    ...
    const getfuelConsData = async () => {
      if (usersData) {
        try {
          ...
          const url = `${baseURL}/api/v1/sitesFuel`;
          const body = {
            usersData: usersData,
            filter:
    ...
    const getoilConsData = async () => {
      if (usersData) {
        try {
          ...
          const url = `${baseURL}/api/v1/sitesOil`;
          const body = {
            usersData: usersData,
            filter:
    ...
    const getbreakdownData = async () => {
      if (usersData) {
        try {
          ...
          const url = `${baseURL}/api/v1/sitesBreakdown`;
          const body = {
            usersData: usersData,
            filter:
    ...
    const getPerMaintData = async () => {
      if (usersData) {
        try {
          ...
          const url = `${baseURL}/api/v1/sitesPerMaint`;
          const body = {
            usersData: usersData,
            filter:
