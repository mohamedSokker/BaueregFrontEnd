...
import useFilter from "../controller/avDrillFilterController";

const AvDrillFilter = ({ copiedData, setData, setIsAvDrillFilterCard }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div
        className={`w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white shadow-xl rounded-lg p-6 transform transition-all duration-500 ease-in-out ${
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <TooltipComponent content="Close" position="BottomCenter">
            <button
              onClick={() => {
                setIsCanceled(true);
                setTimeout(() => setIsAvDrillFilterCard(false), 500);
              }}
