...
import useFilter from "../controller/bdFilterController";

const BdFilter = ({ copiedData, setData, setIsBdFilterCard }) => {
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <TooltipComponent content="Close" position="BottomCenter">
            <button
              onClick={() => {
                setIsCanceled(true);
                setTimeout(() => setIsBdFilterCard(false), 500);
              }}
