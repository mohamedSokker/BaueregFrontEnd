...
import useFilter from "../controller/prodDrillFilterController";

const ProdDrillFilter = ({ copiedData, setData, setIsProdDrillFilterCard }) => {
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <TooltipComponent content="Close" position="BottomCenter">
            <button
              onClick={() => {
                setIsCanceled(true);
                setTimeout(() => setIsProdDrillFilterCard(false), 500);
              }}
...
export default ProdDrillFilter;
