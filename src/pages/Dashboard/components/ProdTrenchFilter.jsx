...
import useFilter from "../controller/prodTrenchFilterController";

const ProdTrenchFilter = ({
  copiedData,
  setData,
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <TooltipComponent content="Close" position="BottomCenter">
            <button
              onClick={() => {
                setIsCanceled(true);
                setTimeout(() => setIsProdTrenchFilterCard(false), 500);
              }}
...
export default ProdTrenchFilter;
