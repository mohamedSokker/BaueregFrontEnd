  ...
  return (
    ...
    >
      <div className="flex flex-row justify-around h-[10%]">
        ...
        <div
          className="w-[20%] h-[100%] px-2 py-4 flex  justify-center items-center cursor-pointer gap-2 text-red-600"
          style={{
            borderBottomWidth: 1,
            borderBottomColor:
              currentCat === "AddDetail" ? logoColor : "rgb(243,244,246)",
          }}
          onClick={() => setCurrentCat("AddDetail")}
        >
          <MdAdd />
          <p className="text-black text-[14px]">AddDetail</p>
        </div>
      </div>
