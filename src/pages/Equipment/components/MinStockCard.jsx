...
import useMinStock from "../controller/minStockController";

const MinStockCard = ({ title, data, currentSpare }) => {
  const { sum } = useMinStock({ data, currentSpare });
