...
const OilSamples = () => {
  ...
  const goBack = () => {
    ...
    // console.log(copiedrelpath, copiedabspath);
  };
    ...
    <>
      ...
      >
        <div className="w-full flex md:flex-row flex-col mb-6 items-center md:gap-0 gap-2">
          ...
          {usersData[0]?.roles?.Editor?.OilSamples === true && (
            <>
              <button
        ...
        <div className="flex flex-col justify-center">
          {filesItems.map((file, i) => (
            <div key={i} className=" w-full flex flex-row mb-4 justify-between">
              ...
              {usersData[0]?.roles?.Editor?.OilSamples === true && (
                <div className="flex md:flex-row flex-col md:gap-0 gap-2 items-center justify-center">
                  <button
